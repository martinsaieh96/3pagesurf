        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-8">
              En EscuelaSurf, combinamos más de una década de experiencia en enseñanza de surf con la pasión por las olas de Chile. Nuestro equipo de instructores certificados te guiará desde tu primera remada hasta tu mejor maniobra, en el corazón de las mejores playas del país. ¡Ven a descubrir por qué Chile es uno de los mejores destinos para surfear y únete al espíritu de la ola!
            </p>
